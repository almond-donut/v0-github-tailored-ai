...
function StepperIndicator({
  ...
  return (
    <span
      ...
      className={cn(
        "bg-neutral-800 text-neutral-400 data-[state=active]:bg-neutral-300 data-[state=completed]:bg-neutral-300 data-[state=active]:text-neutral-900 data-[state=completed]:text-neutral-900 relative flex h-[1.425rem] w-[1.425rem] shrink-0 items-center justify-center rounded-full text-xs font-medium",
        className
      )}
      data-state={state}
      {...props}
